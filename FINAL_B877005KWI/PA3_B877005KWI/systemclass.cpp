...
bool SystemClass::Frame()
{
	...
	{
		//camYaw += m_Input->GetMouseLastState().lX * 0.001f;

		//camPitch += mouseCurrState.lY * 0.001f;
		
		//m_Graphics->SetMoveLeftRight(0.1f);
		//m_Graphics->SetYawPitch(m_Input->GetMouseLastState().lX * 0.001f, mouseCurrState.lY * 0.001f);
		//m_Graphics->SetYawPitch(m_Input->GetMouseLastState().lX * 0.001f, 0.0f);
		//m_Graphics->SetYawPitch(0.0f, m_Input->GetMouseLastState().lY * 0.001f);
		//m_Graphics->SetYawPitchRoll(XM_PI / 90, 0.0f, 0.0f);
