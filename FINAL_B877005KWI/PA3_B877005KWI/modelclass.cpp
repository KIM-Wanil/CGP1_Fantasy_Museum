...
ModelClass::ModelClass()
{
	...
	m_instanceCount[8] = 1;
	m_instanceCount[9] = 1;
	m_instanceCount[10] = 1;
	m_instanceCount[11] = 1;
	m_instanceCount[12] = 1;
	m_instanceCount[13] = 1;
	m_instanceCount[14] = 1;
...
void ModelClass::SetPosition(InstanceType* instances, int objNum)
{
	...
	{
	case 0:
		instances[0].position = XMFLOAT3(0.0f, -3.0f, 5.0f);
		break;
	...
	//	break;
	case 3:
		instances[0].position = XMFLOAT3(-30.0f, 0.0f, -550.0f);
		instances[1].position = XMFLOAT3(-260.0f, 0.0f, -550.0f);
		instances[2].position = XMFLOAT3(-30.0f, 0.0f, 500.0f);

	

		instances[3].position = XMFLOAT3(-260.0f, 0.0f, 500.0f);
		instances[4].position = XMFLOAT3(210.0f, 0.0f, 500.0f);


		instances[5].position = XMFLOAT3(420.0f, 0.0f, 500.0f);
		instances[6].position = XMFLOAT3(210.0f, 0.0f, -550.0f);
		instances[7].position = XMFLOAT3(420.0f, 0.0f, -550.0f);
		break;
	//case 4:
	//	instances[0].position = XMFLOAT3(0.0f, 0.0f, 0.0f);
	//	break;
